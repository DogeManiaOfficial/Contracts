...
contract TestToken is Context, IBEP20, Ownable {
    ...
    function reflectionFromToken(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
        ...
        (uint256 rAmount, uint256 rTransferAmount,,,,,,) = _getValues(tAmount, msg.sender);
    ...
    function unlockTokens(address _lockerUnitAddr) public {
        require(_lockerUnitsTimer[msg.sender][_lockerUnitAddr] > block.timestamp, "Tokens release time is before current time");
